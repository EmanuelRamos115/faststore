...
import LiturgicalCalendarProductGallery from './WorshipPlanning/LiturgicalCalendarProductGallery'
...
import ScriptureSearchResult from './WorshipPlanning/ScriptureSearchResult'
...
export default {
  ...
  ImageAndText,
  ListTabButtons,
  LiturgicalCalendarProductGallery,
